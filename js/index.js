...
(function() {
  ...
  function postDate() {
    ...
    var sa = body.getAttribute("data-post-format") || "dd.mm.yyyy",
      ...
      months,
      countryName = postLang
        ? postLang
        : window.country_code
        ? window.country_code.toLowerCase()
        : "th",
      // Мова для місяців.
  ...
  var composition = function() // $('.composition-content__circle').on('click', function() {
  //   $(this).parent().toggleClass('active');
  // });
  // $(document).mouseup(function (e){
  //   const compositionItem = $(".composition-content__item-wrap.active");
  //   if (!compositionItem.is(e.target) && compositionItem.has(e.target).length === 0) {
  //         $(".composition-content__item-wrap").removeClass('active');
  //   }
  // });
  {
    // $('.composition-content__item-wrap').on('mouseover', function () {
    ...
    $(".composition-content__item-wrap").on("mouseout", function() {
      if ($(this).hasClass("active")) {
        $(".composition-content__item-wrap").removeClass("active");
      } else {
        $(".composition-content__item-wrap").removeClass("active");
